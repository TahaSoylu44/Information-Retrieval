...
def has_numbers(anystring: str) -> bool:
    """Look for a number in the given string"""
    return any(char.isdigit() for char in anystring)

def eliminate_numbers(mylist: list) -> list:
    over_all = []

    for tokenized_sentence in  mylist:
        sub_list = []
        ...
        over_all.append(sub_list)

    return over_all

def replace_numbers(mylist: list) -> list:
    over_all = []
